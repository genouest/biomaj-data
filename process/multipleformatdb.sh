# !/bin/bash
# Applique un formatdb.sh (un des post process biomaj) sur plusieurs repertoires 
...
# exemple d'appel:
# BLOCKS=FASTA_BLAST
# FASTA_BLAST.db.post.process= M1
# M1=multipleformatdb
# multipleformatdb.type=index
# multipleformatdb.name=formatdbAll
# multipleformatdb.args="fasta/Nucleotide_coding_regions/*/all.ffn" 1 "blast" "fungi_ffn"
# multipleformatdb.exe=multipleformatdb.sh
# multipleformatdb.desc=Index blast
